...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('PublicBundle:Tag')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('PublicBundle\Form\TagType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('PublicBundle\Form\TagType', $tag);
